...
┌───────────────────────────────────────────────────────────────────────┐
│ PHASE 3: AUTONOMOUS MISSIONS (ADVANCED) 🤖🌳                          │
└───────────────────────────────────────────────────────────────────────┘

  ┌─────────────────────────────────────────────────────────────────────┐
  │ Option D: Behavior Tree Autonomous Mission 🌳                       │
  ├─────────────────────────────────────────────────────────────────────┤
  │   PREREQUISITE: Navigation must be running first (Option A/B/C)!    │
  │                                                                     │
  │   ./05_behavior_tree_mission.sh                                     │
  │   • High-level mission orchestration                                │
  │   • Sequential waypoint navigation                                  │
  │   • Task execution at each waypoint                                 │
  │   • Fully autonomous operation                                      │
  │                                                                     │
  │   Mission sequence:                                                 │
  │     1. Navigate to (2.1, 0.0)                                       │
  │     2. Execute Task 1 (print "hello")                               │
  │     3. Navigate to (0, -1.2)                                        │
  │     4. Execute Task 2 (print "hi")                                  │
  │                                                                     │
  │   📝 Customize: Edit behavior_tree/robot_navigation_bt.py           │
  │   📚 Docs: ../PYTREES_INTEGRATION_GUIDE.md                          │
  └─────────────────────────────────────────────────────────────────────┘
